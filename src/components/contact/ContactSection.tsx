            ...
            <div className="p-6 bg-white rounded-3xl border border-slate-200 shadow-xs space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@vitarey.com" className="text-sm font-bold text-slate-900 hover:text-blue-600">
                    support@vitarey.com
                  </a>
                </div>
              </div>
              ...
              {success ? (
                <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-200 text-center space-y-2">
                  ...
                  <p className="text-xs text-emerald-700">
                    Votre demande a été transmise à notre support (support@vitarey.com). Nous reviendrons vers vous très rapidement.
                  </p>
                  <button
