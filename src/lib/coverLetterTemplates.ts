 ...
 * Modèles professionnels de lettres de motivation certifiés et typés TypeScript.
 * Prêt pour utilisation instantanée et personnalisation via interpolation.
 */
 ...
 */
export function interpolateCoverLetter(templateText: string, variables: CoverLetterVariables = {}): string {
  if (!templateText) return '';

  const defaultVars: CoverLetterVariables = {
